...
// 	delayms(200);
	u16 op[8] , i;
	op[0] = GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_8);
	op[1] = GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_9);
	op[2] = GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_10);
	op[3] = GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_11);
	op[4] = GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_12);
	op[5] = GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_13);
	op[6] = GPIO_ReadInputDataBit(GPIOA , GPIO_Pin_14);
	delayms(20);
	for ( i = 0 ; i <=6 ; i++ )
	{
		if(op[i]==0)
		{
			oper_status = 1; oper_val = 10+i;
		}
	}
	delayms(90);
}
